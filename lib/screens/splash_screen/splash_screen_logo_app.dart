...
class _SplashScreenLogoAppState extends State<SplashScreenLogoApp>
  ...
  void initState() {
    ...
    _startAnimation();
    logWithColorYouCanOpenPathFile(
        '/Users/xuannam/Documents/GitHub/kmed-app/lib/screens/splash_screen/splash_screen_logo_app.dart');
  }
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          Center(
            child: Container(
              width: sizeConfigResponsive.getWidthReposive(140.0),
              height: sizeConfigResponsive.getWidthReposive(140.0),
              decoration: BoxDecoration(
                color: Colors.white,
                borderRadius: BorderRadius.circular(
                  sizeConfigResponsive.getWidthReposive(70),
                ),
