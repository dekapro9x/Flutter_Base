...
class _SplashScreenState extends State<SplashScreenAppAnimations>
  ...
  Future<void> _checkFirstTime() async {
    ...
    // String navigationRoute = firstTime
      ...
      body: Stack(
        children: [
          ...
          _buildBackgroundCircle(
              bottom: 0,
              right: 0,
              //Sigma (σ) là tham số chính: Trong kỹ thuật làm mờ Gaussian, sigma (σ) xác định mức độ lan tỏa của hiệu ứng làm mờ.
              //Giá trị sigma càng cao, vùng ảnh bị làm mờ càng lớn và các chi tiết trong ảnh càng trở nên mờ nhạt hơn.
              blurSigma: 100.0,
              color: GlobalColors.primaryColor.withOpacity(0.3),
              radius: const BorderRadius.only(topLeft: Radius.circular(95))),
          Positioned(
